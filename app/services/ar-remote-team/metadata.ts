...
export const metadata: Metadata = {
  ...
  description:
    "Get a dedicated AR development team with SyntaxLeap. Our remote augmented reality specialists build immersive experiences and cutting-edge AR solutions for your business.",
  openGraph: {
    title: "AR Remote Team Services | SyntaxLeap - Augmented Reality Development",
    description:
