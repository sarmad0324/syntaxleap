  ...
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden bg-gradient-to-br from-gray-50 to-white">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/3 left-1/4 w-64 h-64 bg-blue-900/5 rounded-full blur-3xl animate-float"></div>
        <div
          className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-teal-500/5 rounded-full blur-3xl animate-float"
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-medium text-blue-900">Our Story & Mission</span>
          </motion.div>
          ...
          >
            About <span className="gradient-text">SyntaxLeap</span>
          </motion.h1>
          ...
          >
            We're on a mission to democratize AI for every business, big or small.
          </motion.p>
        </motion.div>
      </div>
    </section>
